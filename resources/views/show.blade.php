                            ...
                            <div class="bg-gray-900 rounded">
                                ...
                                <div class="modal-body px-8 py-8">
                                    ...
                                    style="padding-top: 56.25%">
                                        <iframe width="560" height="315" class="responsive-iframe absolute top-0 left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key']}}"
                ...
                @foreach ($movie['images']['backdrops'] as $backdrop)
                    @if ($loop->index < 9)  
                        <div class="mt-8">
                            ...
                            "
                            href="#">
                                <img src="{{'https://image.tmdb.org/t/p/w500/'.$backdrop['file_path']}}" alt="actor5" class="hover:opacity-50 transition ease-in-out duration-150">
                            </a>
                        </div>
                    @endif
                @endforeach
